"""
SehatSetu - Brain Tumor MRI Model Training Script
...
DATASET_CANDIDATES = [
    os.path.join(PROJECT_ROOT, "organized_datasets", "Neurological", "Brain_Tumor", "brain tumour", "Training"),
    os.path.join(PROJECT_ROOT, "organized_datasets", "Neurological", "Brain_Tumor", "brain tumour"),
    os.path.join(PROJECT_ROOT, "organized_datasets", "Neurological", "Brain_Tumor")
]

MODEL_SAVE_DIR = os.path.join(PROJECT_ROOT, "SehatSetu", "models", "image", "brain_tumor")
RESULTS_SAVE_DIR = os.path.join(PROJECT_ROOT, "SehatSetu", "results", "image", "brain_tumor")
...
def load_datasets(dataset_path):
    print("=" * 60)
    print("SEHATSETU - BRAIN TUMOR MRI CLASSIFIER TRAINING")
    print("=" * 60)
...
def save_artifacts(model, history, y_true, y_pred, class_names):
    ...
    model_save_path = os.path.join(MODEL_SAVE_DIR, "brain_tumor_model.keras")
    model.save(model_save_path)
    print(f"Saved model to: {model_save_path}")
    
    metrics_path = os.path.join(RESULTS_SAVE_DIR, "metrics.txt")
    with open(metrics_path, "w", encoding="utf-8") as f:
        f.write("SEHATSETU - BRAIN TUMOR MRI EVALUATION METRICS\n")
        f.write("=" * 50 + "\n\n")
    ...
    plt.title("Confusion Matrix - MobileNetV2 (Brain Tumor MRI)")
    ...
    print("\nBrain Tumor MRI training workflow completed successfully!")
