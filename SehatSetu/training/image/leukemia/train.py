"""
SehatSetu - Leukemia Microscopic Image Detection Model Training Script
...
DATASET_CANDIDATES = [
    os.path.join(PROJECT_ROOT, "organized_datasets", "Hematology", "Leukemia", "luekemina", "Original"),
    os.path.join(PROJECT_ROOT, "organized_datasets", "Hematology", "Leukemia", "luekemina", "Segmented"),
    os.path.join(PROJECT_ROOT, "organized_datasets", "Hematology", "Leukemia", "luekemina"),
    os.path.join(PROJECT_ROOT, "organized_datasets", "Hematology", "Leukemia")
]

MODEL_SAVE_DIR = os.path.join(PROJECT_ROOT, "SehatSetu", "models", "image", "leukemia")
RESULTS_SAVE_DIR = os.path.join(PROJECT_ROOT, "SehatSetu", "results", "image", "leukemia")
...
def load_datasets(dataset_path):
    print("=" * 60)
    print("SEHATSETU - LEUKEMIA IMAGE CLASSIFIER TRAINING")
    print("=" * 60)
...
def save_artifacts(model, history, y_true, y_pred, class_names):
    ...
    model_save_path = os.path.join(MODEL_SAVE_DIR, "leukemia_model.keras")
    model.save(model_save_path)
    print(f"Saved model to: {model_save_path}")
    
    metrics_path = os.path.join(RESULTS_SAVE_DIR, "metrics.txt")
    with open(metrics_path, "w", encoding="utf-8") as f:
        f.write("SEHATSETU - LEUKEMIA MODEL EVALUATION METRICS\n")
        f.write("=" * 50 + "\n\n")
    ...
    plt.title("Confusion Matrix - MobileNetV2 (Leukemia)")
    ...
    print("\nLeukemia image training workflow completed successfully!")
